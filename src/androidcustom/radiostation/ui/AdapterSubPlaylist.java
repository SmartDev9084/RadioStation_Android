...
//==============================================================================
public class AdapterSubPlaylist extends AdapterBaseList {

	//------------------------------------------------------------------------------
	public AdapterSubPlaylist(Context a_context, ListView a_listView) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		convertView = GetInflateView(position, convertView, parent, R.layout.listitem_subplaylist);
		...
		imgViewItem			= (ImageView)convertView.findViewById(R.id.ID_IMGVIEW_ITEM_SUBPLAYLIST);
		imgViewItemBack		= (ImageView)convertView.findViewById(R.id.ID_IMGVIEW_ITEM_SUBPLAYLIST_BACK);
		txtViewItem			= (TextView)convertView.findViewById(R.id.ID_TXTVIEW_ITEM_SUBPLAYLIST);
		txtViewItemSubText	= (TextView)convertView.findViewById(R.id.ID_TXTVIEW_ITEM_SUBPLAYLIST_SUBTEXT);
