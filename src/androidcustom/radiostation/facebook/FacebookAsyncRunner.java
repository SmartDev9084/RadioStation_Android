...
package androidcustom.radiostation.facebook;
...
public class FacebookAsyncRunner {
	...
	//------------------------------------------------------------------------------
	public FacebookAsyncRunner(Facebook fb) {
		this.fb = fb;
	}
	 ...
	 */
	//------------------------------------------------------------------------------
	public void LogOut(final Context context, final FacebookRequestListener listener, final Object state) {
		new Thread() {
			@Override public void run() {
				...
				catch (FileNotFoundException e) { listener.OnFileNotFoundException(e, state); }
				catch (MalformedURLException e) { listener.OnMalformedUrlException(e, state); }
				catch (IOException e) { listener.OnIoException(e, state); }
			}
		}.start();
	}

	//------------------------------------------------------------------------------
	public void LogOut(final Context context, final FacebookRequestListener listener) {
	 ...
	 */
	//------------------------------------------------------------------------------
	public void Request(Bundle parameters, FacebookRequestListener listener, final Object state) {
		Request(null, parameters, "GET", listener, state);
	}

	//------------------------------------------------------------------------------
	public void Request(Bundle parameters, FacebookRequestListener listener) {
	 ...
	 */
	//------------------------------------------------------------------------------
	public void Request(String graphPath, FacebookRequestListener listener, final Object state) {
		Request(graphPath, new Bundle(), "GET", listener, state);
	}

	//------------------------------------------------------------------------------
	public void Request(String graphPath, FacebookRequestListener listener) {
	 ...
	 */
	//------------------------------------------------------------------------------
	public void Request(String graphPath, Bundle parameters, FacebookRequestListener listener, final Object state) {
		Request(graphPath, parameters, "GET", listener, state);
	}

	//------------------------------------------------------------------------------
	public void Request(String graphPath, Bundle parameters, FacebookRequestListener listener) {
	...
	public void Request(final String graphPath,
						...
						final FacebookRequestListener listener,
						final Object state) {
		new Thread() {
			@Override public void run() {
				try {
	 ...
	 */
	//==============================================================================
	public static interface FacebookRequestListener {
