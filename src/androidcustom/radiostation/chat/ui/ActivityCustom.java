...
import androidcustom.radiostation.chat.utils.TouchEffect;
 ...
 */
public class ActivityCustom extends FragmentActivity implements OnClickListener {
	/**
	...
	protected void setupActionBar() {
		...
		actionBar.setLogo(R.drawable.img_chat_icon);
		actionBar.setBackgroundDrawable(getResources().getDrawable(
				R.drawable.img_chat_actionbar_bg));
