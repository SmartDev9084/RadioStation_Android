package androidcustom.radiostation.chat.model;

import java.util.Date;

import androidcustom.radiostation.chat.ui.ActivityChatUserList;
...
public class Conversation {
	...
	public boolean isSent() {
		return ActivityChatUserList.user.getUsername().equals(sender);
	}
